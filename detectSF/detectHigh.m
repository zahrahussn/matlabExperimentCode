...
%    calibrationMethod='bitStealing';
    ...
    defarg('detectHighTEXTfolder','detectHighTEXTfiles');	% N.B. make sure this folder exists within the folder containing 'trialslab'!
    defarg('detectHighMATfolder','detectHighMATfiles');		% N.B. make sure this folder exists within the folder containing 'trialslab'!

    % set the paths
    disp('setting path names...');
    mfilename='detectHigh'; mainfile = [mfilename,'.m'];
    ...
    textdatadir=[mainpath,detectHighTEXTfolder];
    matdatadir=[mainpath,detectHighMATfolder];
    cd(mainpath);
    disp(mainpath);
