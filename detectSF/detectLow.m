...
%    calibrationMethod='psychophysical';
    ...
    %RandStream.create('mt19937ar','seed',sum(100*clock)); % legacy generator initialized
    ...
    thresholdguess=[0.000024, 0.00019]; %May 30, 2022; high noise guess raised
