function betaEstimate=pbQuestBetaEstimate(q,fid)
% betaEstimate=pbQuestBetaEstimate(q,[fid]);
% 
...
% 01/29/07 pjb changed file name; altered details

if nargin<1 | nargin>2
	error('Usage: pbQuestBetaEstimate(q,[fid])')
end
if nargin<2
	fid=1;
end
